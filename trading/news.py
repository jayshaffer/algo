"""Alpaca news fetching and filtering."""
...
def fetch_news(
    ...
    Args:
        hours: How far back to fetch news (default 24 hours)
        symbols: Optional list of symbols to filter by (None = broad coverage)
...
def fetch_broad_news(hours: int = 24, limit: int = 50) -> list[NewsItem]:
    ...
    This is the primary method for the news pipeline - we want to capture
    macro/political news that may not be tagged with specific symbols.
    """
