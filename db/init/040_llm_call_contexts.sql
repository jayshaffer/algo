-- 040_llm_call_contexts.sql — mirror of db/migrations/006_llm_call_contexts.sql.
--
-- Same gap as 039: this table existed only in db/migrations/ from 2026-05
-- until the 2026-08-13 audit (finding 2.2), so no fresh volume ever had it.
--
