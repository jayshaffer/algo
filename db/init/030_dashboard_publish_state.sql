-- Persistent dashboard publish state.
-- Tracks git pointers for generated public pages so publish jobs can render
-- incremental changelog ranges instead of scanning arbitrary history.
